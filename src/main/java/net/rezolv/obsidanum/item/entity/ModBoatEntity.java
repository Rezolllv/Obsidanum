...
public class ModBoatEntity extends Boat {
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case OBSIDAN -> ItemsObs.OBSIDAN_BOAT.get();
        };
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.OBSIDAN.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        OBSIDAN(BlocksObs.OBSIDAN_PLANKS.get(), "obsidan");
        ...
        public static ModBoatEntity.Type byName(String pName) {
            return CODEC.byName(pName, OBSIDAN);
        }
    }
}