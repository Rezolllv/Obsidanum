...
@OnlyIn(Dist.CLIENT)
public class BagelEnchantParticle extends  TextureSheetParticle {
    private final double xStart;
    private final double yStart;
    private final double zStart;

    BagelEnchantParticle(ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            BagelEnchantParticle enchantmenttableparticle = new BagelEnchantParticle(pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed);
